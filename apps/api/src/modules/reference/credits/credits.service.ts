...
import type { ICreditsRepository } from '../../../database/repositories/interfaces/credits-repository.interface';
import { CREDITS_REPOSITORY } from '../../../database/repositories/tokens/repository.tokens';
